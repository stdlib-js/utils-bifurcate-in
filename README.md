...
```javascript
import bifurcateIn from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-bifurcate-in@v0.1.0-esm/index.mjs';
```
...
[@stdlib/utils/group-in]: https://github.com/stdlib-js/utils-group-in/tree/esm
